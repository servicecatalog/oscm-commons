...
//
//    changeFileAppenderIfNew(logger.systemLogger, systemLogAppenderName, systemLogAppender);
//
//    changeFileAppenderIfNew(logger.accessLogger, accessLogAppenderName, accessLogAppender);
//
//    changeFileAppenderIfNew(logger.auditLogger, auditLogAppenderName, auditLogAppender);
//
//    changeFileAppenderIfNew(
//        logger.proxyLogger, reverseProxyLogAppenderName, reverseProxyLogAppender);
//
//    setLogLevel(logger, level);
//  }

//  private static void changeFileAppenderIfNew(
//      Logger logger, RollingFileAppender newFileAppender) {
