...
public class ArgumentValidator {
  ...
  public static void notNull(String name, Object arg) throws IllegalArgumentException {
    if (arg == null) {
  ...
  public static void notEmptyString(String name, String arg) throws IllegalArgumentException {
    notNull(name, arg);
