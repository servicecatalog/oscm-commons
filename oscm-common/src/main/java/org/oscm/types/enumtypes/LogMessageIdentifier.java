...
public enum LogMessageIdentifier {
  ...
  INFO_IDENTITY_CLIENT_RESPONSE("00025"), //
  INFO_SYNCHRONIZATION("00026"),
  ...
  ERROR_TOKEN_VALIDATION_FAILED("70324"), //
  ERROR_IDENTITY_CLIENT_DETAILS("70325"), //
  ERROR_SYNCHRONIZATION("70326"), //
  ERROR_INVALID_BASE_URL("70327"), //
